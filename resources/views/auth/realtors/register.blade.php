                    ...
                    <div class="row">
                        <div class="col-lg-12 align-self-center">
                            <div class="ltn__breadcrumb-inner">
                                <h1 class="page-title">Realtor | Sign up</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="account-login-inner">
                    ...
                    <form method="post" action="{{ route('realtor.register.submit') }}"
            ...
            <div class="col-lg-4">
                <aside class="sidebar-area ltn__right-sidebar">
                    ...
                    <div class="widget-2 ltn__menu-widget ltn__menu-widget-2 text-uppercase">
                        <ul>
                            <li><a href="{{ route('realtor.login') }}">Have an account? Log in
                                    <span><i class="fas fa-arrow-right"></i></span></a></li>
                            <li><a href="{{ route('login') }}">Sign up as a user
                                    <span><i class="fas fa-arrow-right"></i></span></a></li>
                        </ul>
                    </div>
