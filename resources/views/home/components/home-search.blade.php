                                ...
                                <div class="tab-pane fade active show" id="ltn__form_tab_1_1">
                                    <div class="car-dealer-form-inner">
                                        ...
                                        <form method="get" action="{{ route('properties.search') }}"
                                            ...
                                            <div class="ltn__car-dealer-form-item ltn__custom-icon col-lg-4 col-md-6 search-more-input d-none">
                                            ...
                                            <div class="ltn__car-dealer-form-item ltn__custom-icon col-lg-6 col-md-6 search-more-input d-none">
                                            ...
                                            <div class="ltn__car-dealer-form-item ltn__custom-icon col-12 d-flex justify-content-center">
                                                <i title="More filter" id="search-more-angle"
                                                   class="fa fa-angle-down fa-2x text-left"
