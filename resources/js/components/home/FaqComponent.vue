<template>
    ...
    <div class="ltn__slider-area ltn__slider-3 section-bg-2">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1">
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-3-normal--- ltn__slide-item-3 bg-overlay-theme-black-60" style="background-image: url('/main-assets/img/slider/14.jpg');  background-size: cover; background-repeat: no-repeat;  background-position: center; background-attachment: fixed;">
                                ...
                                <div id="faq-item-2-2" class="collapse" data-bs-parent="#accordion_2" style="">
                                    <div class="card-body">
                                        <div class="ltn__video-img alignleft">
                                            <img src="/main-assets/img/bg/17.jpg"
